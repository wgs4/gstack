...
> **Fork:** This is [wgs4/gstack](https://github.com/wgs4/gstack), a fork of upstream [garrytan/gstack](https://github.com/garrytan/gstack). Install commands below point at this fork. See upstream for the canonical README.
...
```bash
git clone --single-branch --depth 1 https://github.com/wgs4/gstack.git ~/gstack
cd ~/gstack && ./setup
```
